...
class AmbientLight : public Actor
{
public:
    AmbientLight();
    AmbientLight(const SampleInitInfo& InitInfo, RefCntAutoPtr<IRenderPass>& RenderPass, IShaderSourceInputStreamFactory* pShaderSourceFactory);
